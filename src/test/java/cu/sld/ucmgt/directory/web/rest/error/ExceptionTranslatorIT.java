package cu.sld.ucmgt.directory.web.rest.error;

import cu.sld.ucmgt.directory.DirectoryApp;
import cu.sld.ucmgt.directory.config.TestSecurityConfiguration;
import cu.sld.ucmgt.directory.web.rest.errors.ErrorConstants;
...
/**
 * Integration tests {@link cu.sld.ucmgt.directory.web.rest.errors.ExceptionTranslator} controller advice.
 */
@WithMockUser
